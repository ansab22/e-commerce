  ...
  return (
    <>
      <div className={styles.aboutUs_con}>
        <div className={styles.aboutUs_row}>
          <div className={styles.text_div}>
            <h1 className={styles.h1_aboutUs}>
              <span style={{ color: "#707070", fontWeight: "400" }}>ABOUT</span>{" "}
              US
            </h1>
            <p className={styles.hr_line}></p>
          </div>
          <div className={styles.aboutUs_colums_div}>
            <div className={styles.aboutUs_col1}>
              <img src={`/images/about_img.png`} alt="" />
            </div>
            <div className={styles.aboutUs_col2}>
              ...
              <h4 className={styles.aboutUs_title}>Our Mission:</h4>
              <p className={styles.aboutUs_para}>
